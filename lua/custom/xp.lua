...
function AddXP(amount, skip_cooldown)
...
local function parse_date(date_str)
    return os.time({ year = tonumber(date_str:sub(1, 4)) --[[@as integer]], month = tonumber(date_str:sub(6, 7)) --[[@as integer]], day = tonumber(date_str:sub(9, 10)) --[[@as integer]] })
end
...
local function update_streak()
    ...
    if last == "" then
        ...
        if day_diff == 1 then
            ...
            AddXP(xp_data.stats.streak_days * 5, true)
