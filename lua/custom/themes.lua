...
local function get_colors()
    ...
    local theme_map = {
        ...
        vim_classic = {
            ...
            red = v.dark_red,
            green = v.dark_green,
            yellow = v.dark_yellow,
            blue = v.dark_blue,
            purple = v.dark_magenta,
            aqua = v.dark_cyan,
            orange = v.dark_red,
            gray = v.gray,
        },
...
local function setup_highlights()
    ...
    if Theme.current_theme == "gruvbox_light" or Theme.current_theme == "solarized_light" or Theme.current_theme == "vim_classic" then vim.cmd("set background=light") else vim.cmd("set background=dark") end
